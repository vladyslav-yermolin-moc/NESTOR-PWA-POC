...
This delta introduces the PWA shell capability for the Nestor PWA POC. All requirements are net-new (no prior specs exist for this project). Requirements are organized around the observable behaviors that determine whether the POC passes Nora's install test.
